    ...
    public static class CustomerRepository
    {
        public static decimal GetCustomerOrderTotalByYear(this IRepository<Customer> repository, string customerId, int year)
        {
            return repository
                ...
                .SelectMany(c => c.Customer1.Where(o => o.OrderDate != null && o.OrderDate.Value.Year == year))
        ...
        public static IEnumerable<Customer> GetAllCustomer(this IRepository<Customer> repository)
        {
            var r = repository.GetRepository<Customer>().Queryable();
